...
const byte ledPin = 13; //Using Pin #13 (D10) to turn on and off LED
const byte mhzPin = 10; //Using Pin #10 (D7) to send 433mhz signals to screen
const byte interruptPin = 2; //Nano only works on pin 2 (RX0) or 3 (RST) let's use 2 (RX0)
